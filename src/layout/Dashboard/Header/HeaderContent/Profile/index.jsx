...
import { getAllUsersData } from 'utils/firebaseutils';
    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      ...
      >
        <Stack direction="row" spacing={1.25} alignItems="center" sx={{ p: 0.5 }}>
          <Avatar alt="profile user" src={userData?.profilePic ? userData.profilePic : avatar1} size="sm" />
                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      <Grid item>
                        <Stack direction="row" spacing={1.25} alignItems="center">
                          <Avatar
                            alt="profile user"
                            src={userData?.profilePic ? userData.profilePic : avatar1}
                            sx={{ width: 32, height: 32 }}
                          />
                          <Stack>
                            <Typography variant="h6">{userData?.name}</Typography>
                            <Typography variant="body2" color="text.secondary">
                              {userData?.isAdmin === true ? 'ADMIN' : 'Not Specified'}
                            </Typography>
                          </Stack>
                        </Stack>
                      </Grid>
